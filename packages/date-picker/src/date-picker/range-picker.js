...
const _sfc_main = defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const mergedExchangeTime = computed(() => {
      ...
      return !(
        !exchangeTime.value ||
        !((_a = configCtx == null ? void 0 : configCtx.exchangeTime) != null ? _a : true)
      )
    })
    const {
      mergedSize,
    ...
    const computedPlaceholder = computed(
      () =>
        ...
        datePickerT('datePicker.rangePlaceholder.date')
    )
    const {
    ...
    const panelValue = computed(() => {
      var _a, _b
      return (_b = (_a = previewValue.value) != null ? _a : processValue.value) != null
        ? _b
        : selectedValue.value
    })
    ...
    function confirm(value, showPanel, emitOk) {
      if (
        isDisabledDate(value == null ? void 0 : value[0], 'start') ||
        isDisabledDate(value == null ? void 0 : value[1], 'end')
      ) {
        return
      }
    ...
    ? (openBlock(),
      createBlock(
        ...
        ),
        {
          content: withCtx(() => [
            createVNode(
              _component_RangePickerPanel,
              normalizeProps(guardReactiveProps(_ctx.rangePanelProps)),
              null,
              16
            )
          ]),
          default: withCtx(() => [
            renderSlot(_ctx.$slots, 'default', {}, () => [
              createVNode(
                _component_DateRangeInput,
                mergeProps({ ref: 'refInput' }, _ctx.$attrs, {
                  focusedIndex: _ctx.focusedIndex,
                  'onUpdate:focusedIndex':
                    _cache[0] || (_cache[0] = ($event) => (_ctx.focusedIndex = $event)),
                  size: _ctx.size,
    ...
    : (openBlock(),
      createBlock(
        ...
        normalizeProps(
          mergeProps(
            { key: 1 },
            __spreadValues(__spreadValues({}, _ctx.$attrs), _ctx.rangePanelProps)
          )
        ),
        null,
        16
